  ...
  return (
    <ContentBase title="The Dr. Kobros Foundation">
      ...
      <p>
        ...
        <strong>Dr. Kobros®</strong> branded snake oil and enema machines to the
        ointment-hungry residents of the Wild West from his relentlessly growing
        fleet of snake oil wagons traveling between the settlements.
      </p>
      ...
      <p>
        ...
        peaceful protests with guns he was forced to switch methods. He employed
        terror tactics and waged guerrilla warfare from the mountains. During
        this period he also met his wife, who gave birth to a son, Ragnar II, in
        1904.
      </p>

      <p>
        The greedy and evil Swedes were finally forced into submission in 1905,
        and Norway gained it&apos;s independence. Dr. Kobros led a movement to
        establish a republic with himself as the president, but when the newly
        formed state was threatened by a civil war between Kobros&apos;
      ...
      <p>
        ...
        the Great War was an opportunity he could not let pass by. Between 1914
        and 1918 Kobros sold loads of &quot;wonder weapons&quot; to all warring
        parties. And after the war, when the Spanish Flu struck, his was the
        medicine that gave hope to millions.
      </p>
      ...
      <p>
        ...
        subsidiaries of the Dr. Kobros company were found. Ragnar Kobros became
        the wealthiest man in Norway.
      </p>

      <p>
        Ragnar II, groomed by his father to be his successor, proved himself by
        investing on the roaring stock markets of the 1920s. Young Ragnar saw
        the economic bubble as it was, and on October 28, 1929, he began to
        sell. Next day, on the famous Black Tuesday, his actions caused the Wall
        Street crash; but not before Ragnar II had escaped with his well-earned
        millions.
      </p>
      ...
      <p>
        The national socialists, however, chose to betray the Kobros family. To
        capture the Dr. Kobros heavy water installations and to secure the
        transportation of iron ore mined in the Kobros mines of Sweden from the
        harbors operated by the Kobros economic empire, Germany invaded Norway.
        Ragnar II orchestrated the timely escape of the royal family to England.
        Ragnar&apos;s own family, his wife and his son Ragnar III, followed the
        king to exile, but Ragnar himself chose to stay.
      </p>
      ...
      <p>
        ...
        preventing the Germans from obtaining an atomic bomb. This was the last
        straw for Josef Terboven, the Reichskomissar of occupied Norway, who now
        made good on his threat and had Ragnar&apos;s elderly father shot dead.
        It was a terrible sacrifice, but one willingly made for the greater good
        of the company and it&apos;s assets.
      </p>
      ...
      <p>
        ...
        standing in the East was quickly dismantled by the Soviet Union. Ragnar
        II, his spirit crushed by the death of his beloved father and his health
        diminished by the war years, stepped down as CEO and Chairman in favor
        of his young son, Ragnar III.
      </p>

      <p>
        Ragnar III, wise beyond his years, decided to again concentrate on the
        Kobros&apos; core business: snake oil. It had been an error, he claimed,
        to branch out. Ragnar III swiftly reorganized the whole Kobros corporate
      ...
      <p>
        Currently lead by chairman Ragnar Kobros III and interim CEO Gaylord L.
        Lohiposki, the foundation has lately been focusing on the Internet.
